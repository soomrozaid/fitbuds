...
class UserGym {
  ...
  UserGym copyWithModelFieldValues({
    ModelFieldValue<String?>? gymId,
    ModelFieldValue<String?>? location,
    ModelFieldValue<String?>? membershipPlan
  }) {
    return UserGym._internal(
      gymId: gymId == null ? this.gymId : gymId.value,
      location: location == null ? this.location : location.value,
      membershipPlan: membershipPlan == null ? this.membershipPlan : membershipPlan.value
    );
  }
